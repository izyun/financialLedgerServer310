package com.example.financialLedgerServer310.controller;

import com.example.financialLedgerServer310.service.LedgerServiceImpl;
...
public class ledgerController {
    @WebServlet("/financialLedger")
    public class financialLedger extends HttpServlet {
		 ...
		 */
            ...
            List<Map<String, Object>> list = ledgerServiceImpl.selectFinancialLedger(y, m);
		/*
		 ...
		 */
            ...
            // 3) 뷰 포워딩
            request.getRequestDispatcher("/WEB-INF/view/financialLedger.jsp").forward(request, response);
        }
    }
}